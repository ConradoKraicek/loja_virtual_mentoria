...
import conra.mentoria.lojavirtual.service.ImplementacaoUserDetailsService;
...
public class WebConfigSecurity extends WebSecurityConfigurerAdapter implements HttpSessionListener {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		/*Redireciona ou de um retorno para index quando desloga*/
		...
		/*Filtra demais requisiçoes para verificar a presenção do TOKEN JWT no HEADER HTTP*/
