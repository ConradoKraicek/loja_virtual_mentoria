...
@Entity
@Table(name = "acess_token_junoapi")
@SequenceGenerator(name = "seq_acess_token_junoapi", sequenceName = "seq_acess_token_junoapi", allocationSize = 1, initialValue = 1)
public class AcessTokenJunoAPI implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_acess_token_junoapi")
	private Long id;
