...
import conra.mentoria.lojavirtual.enums.StatusVendaLojaVirtual;
...
public class VendaCompraLojaVirtual implements Serializable {
	...
	@NotNull(message = "A forma de pagaemnto deve ser informado")
	...
	@Min(value = 5, message = "valor do frete é invalido")
	...
	@NotNull(message = "Data da entrega deve ser informado")
	@Column(nullable = false)
	@Temporal(TemporalType.DATE)
